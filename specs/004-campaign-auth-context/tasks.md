...
- [ ] T001 Create campaign constants, V1 default campaign id, and `Profile` to membership-role mapping helpers in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\campaigns.py`
- [ ] T002 [P] Create campaign test factory helpers for users, campaigns, memberships, sessions, and PJs in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\campaign_factories.py`
- [ ] T003 [P] Add BD-4 quick reference rows for `/services/jdr/auth/me` and campaign context commands in `D:\Projets\dev\AI-Kaeyris\docs\memo.md`
...
- [ ] T013 [US1] Add `/services/jdr/auth/me` success tests for MJ and player web sessions in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_auth_me.py`
- [ ] T014 [US1] Add `/services/jdr/auth/me` 401 and `active_campaign: null` tests in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_auth_me.py`
- [ ] T015 [P] [US1] Add active-campaign resolver tests for default campaign, stale default fallback, first membership fallback, and no membership in `D:\Projets\dev\AI-Kaeyris\tests\core\test_campaign_context.py`

### Implementation for User Story 1

- [ ] T016 [US1] Add `AuthMeUserOut`, `AuthMeCampaignOut`, and `AuthMeOut` Pydantic schemas in `D:\Projets\dev\AI-Kaeyris\app\core\user_schemas.py`
- [ ] T017 [US1] Implement `GET /services/jdr/auth/me` with web-session auth, active campaign resolution, and `Cache-Control: no-store` in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\auth_router.py`
- [ ] T018 [US1] Add structured logs for `/auth/me` success, no-campaign, and unauthorized paths without leaking session tokens in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\auth_router.py`
- [ ] T019 [US1] Ensure FastAPI OpenAPI exposes the `/services/jdr/auth/me` response model in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\auth_router.py`
- [ ] T020 [US1] Run focused `/auth/me` tests in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_auth_me.py` and resolver tests in `D:\Projets\dev\AI-Kaeyris\tests\core\test_campaign_context.py`
...
- [ ] T031 [US3] Update `SessionRepository.create`, `list_for_gm`, and `get_for_gm` to accept and filter by active `campaign_id` in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\db\repositories.py`
...
- [ ] T039 [US4] Add tests proving `POST /services/jdr/users` creates exactly one campaign membership with role `mj` or `player` in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_user_campaign_membership.py`
- [ ] T040 [US4] Add tests proving `GET /services/jdr/users` lists only users in the active campaign in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_user_campaign_membership.py`
- [ ] T041 [US4] Add tests proving `PATCH /services/jdr/users/{user_id}` keeps membership role consistent with `profile` in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_user_campaign_membership.py`
- [ ] T042 [US4] Add tests proving `DELETE /services/jdr/users/{user_id}` keeps `campaign_members` rows for auditability in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_user_campaign_membership.py`

### Implementation for User Story 4

- [ ] T043 [US4] Extend `create_user`, `list_users`, `update_user`, and `delete_user` campaign-aware helper behavior without changing response schemas in `D:\Projets\dev\AI-Kaeyris\app\core\users.py`
- [ ] T044 [US4] Resolve active campaign in `POST`, `GET`, `PATCH`, and `DELETE /services/jdr/users` routes and call membership helpers in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\auth_router.py`
- [ ] T045 [US4] Add membership role synchronization when a user's `profile` changes in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\campaigns.py`
- [ ] T046 [US4] Keep soft-delete membership retention explicit and logged in `D:\Projets\dev\AI-Kaeyris\app\services\jdr\auth_router.py`
- [ ] T047 [US4] Run focused campaign-aware user management tests in `D:\Projets\dev\AI-Kaeyris\tests\services\jdr\test_user_campaign_membership.py`
...
- [ ] T048 [P] Update JDR service documentation with campaign context, `/auth/me`, and V1 out-of-scope campaign management notes in `D:\Projets\dev\AI-Kaeyris\docs\services\jdr.md`
...
- [ ] T056 Run full test suite with `pytest` from `D:\Projets\dev\AI-Kaeyris\tests`
- [ ] T057 Run `docker compose config` from `D:\Projets\dev\AI-Kaeyris\docker-compose.yml`
